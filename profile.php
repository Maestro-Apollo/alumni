...
<body class="Main">
    ...
    <div class="container main_info_area">
        ...
        <div class="edit_profile">
            <a class="edit_btn" href="update_Info.php">Edit Profile</a>
        </div>

        <!--    creating a div for user image-->
        <div class="image_area">
            <img style="height:350px;width:350px;border-radius:5px" class="user_image"
                src="user_img/<?php echo $row2['image']; ?>">
        </div>
        ...
        <div class="chngImg">
            <form class="imgForm" method="post" enctype="multipart/form-data">
                ...
                <input class="fileInp" type="submit" id="submitBtn" name="submit" class="btn btn-primary"
                    value="Change Image">
            </form>
        ...
        <div class="user_information">
            <div class="row">
                <div class="col-md-6 name_batch">
                    <label class="Label1">Name - </label><a class="Label" href="#"> <?php echo $row2['name']; ?>
                    </a><br>

                    <label class="Label1">Batch - </label><a class="Label" href="#"> <?php echo $row2['batch']; ?>
                    </a><br>
            ...
            <div class="contact">
                ...
                <label class="Label">Email - </label><a class="Label email" href="#" class="mail">
                    <?php echo $row1['email']; ?>
                </a>
            </div>
        </div>
    ...
    <div class="container main_info_area">
        <div class="user_information">
            <div class="row">
                ...
                <div class="col-md-6 institute">
                    <label class="Label">Joining Date - </label> <a class="Label" href="#"> <?php echo $j_date; ?>
                    </a><br>
                    <label class="Label">Ending Date - </label> <a class="Label" href="#"> <?php echo $e_date; ?>
                    </a><br>
                </div>
            </div>

            <div class="row">
                <a class="Label" href="edit_Job.php?id1=<?php echo $row['id']; ?>"
                    style="padding:10px 10px; text-decoration:none;backgrouond:white;color:black">Edit</a>
                <a class="Label" href="delete_Job.php?id2=<?php echo $row['id']; ?>"
                    style="padding:10px 10px; text-decoration:none;backgrouond:white;color:black">Delete</a>
            </div>
        </div>
    </div>
    <?php
    ...
    <div class="container main_info_area">
        <div class="user_information">
            <div class="row">
                ...
                <div class="col-md-6 institute">
                    Publication date - <a style="text-decoration:none;color:black" href="#"> <?php echo $date; ?>
                    </a><br>
                </div>
            </div>
        </div>
