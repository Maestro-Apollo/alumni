        ...
        <div class="container">
            ...
            <form onsubmit="return validation()">
                ...
                <div class="form-group">
                 ...
                 <div class="input-group mb-3">
                    ...
                    <select class="custom-select" id="inputGroupSelect01">
                      <option selected>Your batch number...</option>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="phoneNumber" name="" class="form-control">
                    <span id="phoneNoError" class="text-danger font-wight-bold"></span>
                </div>

                <div class="form-group">
                    <label>Current Country</label>
                    <input type="text" id="currentCountry" name="" class="form-control">
                    <span id="crntCountryError" class="text-danger font-wight-bold"></span>
                </div>

                <div class="form-group">
                    <label>Current City</label>
                    <input type="text" id="currentCity" name="" class="form-control">
               ...
               <!--no need for now-->
                ...
                <div class="custom-file mb-3">
                    ...
                    <input type="submit" id="submitBtn" name="" class="btn btn-primary">
